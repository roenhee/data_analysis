...
DESCRIPTOR = {
    ...
    "invocation": "run_analysis(config, source, analysis_type, params, run_id, config_version, aggregate_fetcher=None); params={window,grain,breakdown,filters}; 사용법은 skill 'basic-analysis'",
    "expected_params": {
